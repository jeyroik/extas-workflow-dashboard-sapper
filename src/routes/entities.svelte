...
<Create entity="entities" text="Создать сущность"/>
...
<table>
    ...
    {#each entities as item}
        <tr>
            <td title="{item.name}">
                <Property bind:value={item.name} editable={false}/>
            </td>
            <td title="{item.title}">
            ...
            <td style="min-width: 200px">
                <button class="btn btn-danger" title="Удалить" on:click={deleteEntity(item, 'entity', 'Сущность', e => false, '', afterDelete)}>
                ...
                <button class="btn btn-primary" title="Сохранить изменения" on:click={save(item, 'entity', 'Сущность')} value="">
