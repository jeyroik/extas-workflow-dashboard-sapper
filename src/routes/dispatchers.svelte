...
<Create entity="dispatchers" text="Создать обработчик"/>
    ...
    {#each entities as item}
        <tr>
            ...
            <td style="min-width: 200px">
                <button class="btn btn-danger" title="Удалить" on:click={deleteEntity(item, 'transition.dispatcher', 'Обработчик', e => false, '', afterDelete)}>
                ...
                <button class="btn btn-primary" title="Сохранить изменения" on:click={save(item, 'transition.dispatcher', 'Обработчик')} value="">
