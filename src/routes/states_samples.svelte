...
<Create entity="states_samples" text="Создать шаблон"/>
...
<table>
    ...
    {#each entities as item}
        <tr>
            ...
            <td title="Количество состояний, созданных по этому шаблону">{item.states.length}</td>
            <td style="min-width: 200px">
                <button class="btn btn-danger" title="Удалить" on:click={deleteEntity(item, 'state.sample', 'Шаблон состояния', e => false, '', afterDelete)}>
