<script context="module">
    export function preload({ params, query }) {
        ...
        return this.fetch('process.JSON_RPC__ENDPOINT', {
            method: 'POST',
            body: JSON.stringify({method: "workflow.entity.sample.index"})
...
<svelte:head>
    <title>Шаблоны сущностей</title>
</svelte:head>

<h2>Шаблоны сущностей - именованные объекты, использующиеся для создания новых сущностей.</h2>
...
<Create entity="entities_samples" text="Создать шаблон сущности"/>
    ...
    {#each entities as item}
        <tr>
            ...
            <td style="min-width: 200px">
                <button class="btn btn-danger" title="Удалить" on:click={deleteEntity(item, 'entity.sample', 'Шаблон сущности', e => false, '', afterDelete)}>
                ...
                <button class="btn btn-primary" title="Сохранить изменения" on:click={save(item, 'entity.sample', 'Шаблон сущности')} value="">
